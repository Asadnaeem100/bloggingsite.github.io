...
$query = mysqli_query($config, $sql);
    $sql2 = "SELECT * FROM blog LEFT JOIN categories ON blog.category =
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea required class="form-control" name="blog_body" rows="2" id="blog"><?php echo $result['blog_body'] ?></textarea>
                            <div class="mb-3">
                                <input type="file" name="blog_image" class="form-control">
                                <img src="upload/<?php echo $result['blog_image'] ?>" width="100px">
                            </div>
                            <div class="mb-3">
                                ...
                                <?php echo ($result['category']==$cats['cat_id'])?"selected":''; ?>>
