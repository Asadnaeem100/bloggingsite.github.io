<?php
    ...
    if(isset($_POST['add_user'])) {
        ...
        {
           $error = "Password must be between 4 character long";
        }
        elseif($pass != $c_pass){
    ...
    <div class="row">
        <div class="col-md-5 m-auto bg-info p-4">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    <input type="text" name="username" placeholder="Username" class="form-control" required value="<?php echo (!empty($error))? $username: ''; ?>">
                </div>
                <div class="mb-3">
                    <input type="email" name="email" placeholder="Email" class="form-control" required value="<?php echo (!empty($error))? $email: ''; ?>">
                </div>
                <div class="mb-3">
